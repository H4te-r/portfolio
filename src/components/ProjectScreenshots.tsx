  ...
  return (
    <>
      <button
        ...
        className="relative mb-4 block aspect-[16/10] w-full overflow-hidden rounded-xl border border-slate-800 bg-[#111a2e] text-left"
      ...
      {extras.length > 0 && (
        <button
          ...
          className="mb-4 text-xs text-slate-500 transition-colors hover:text-cyan-400"
        >
      ...
      {active && openIndex !== null && (
        ...
        >
          ...
          >
            ...
            <div className="relative aspect-[16/10] w-full overflow-hidden rounded-xl border border-slate-700 bg-[#0a0f1e]">
              <Image
                src={active.src}
                alt={active.alt}
                fill
